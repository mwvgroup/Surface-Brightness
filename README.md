...
The steps hold for any source file, and the no further changes should be necessary. Fits files used to generate the results in this repository have been uploaded to Marduk at `/home/depot/WIYN/GALEX/fits files/`. (After compiling a list of file paths, the script uses a .csv file to build a dictionary of redshifts and coordinates for each supernova of interest.)
